...
Page({
  ...
  getContellDetail:function(constellid){
    var that = this
    wx.request({
      url: app.globalData.api_url +'/Smallapp3/constellation/getVideoList',
      header: {
    ...
    wx.request({
      url: app.globalData.api_url +'/Smallapp3/constellation/getConstellationDetail',
      header: {
        'content-type': 'application/json'
      },
      data: {
  ...
  onLoad: function(options) {
    ...
    wx.request({
      url: app.globalData.api_url +'/Smallapp21/index/happylist',
      header: {
        'content-type': 'application/json'
      },
      success:function(res){
    ...
    wx.request({
      url: app.globalData.api_url +'/Smallapp3/constellation/getConstellationList',
      header: {
        'content-type': 'application/json'
      },
      success:function(res){
    ...
    //红包送祝福开关
    wx.request({
      url: app.globalData.api_url +'/smallapp3/Redpacket/getConfig',
      header: {
        'content-type': 'application/json'
      },
      data:{
