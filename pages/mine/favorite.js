...
Page({
  ...
  onLoad: function(options) {
    ...
    wx.request({
      url: app.globalData.api_url +'/Smallapp3/User/getMyCollect',
      headers: {
        'Content-Type': 'application/json'
      },
      data: { openid: openid },
            ...
            wx.showModal({
              ...
              success: function (res) {
                if (res.confirm) {
                  ...
                  wx.request({
                    url: app.globalData.api_url +'/Smallapp21/CollectCount/recCount',
                    headers: {
                      'Content-Type': 'application/json'
                    },
                    data: {
  ...
  modalConfirm: function(e) {
    ...
    wx.request({
      url: app.globalData.api_url +'/Smallapp/User/delMycollect',
      headers: {
        'Content-Type': 'application/json'
      },
      data: {
